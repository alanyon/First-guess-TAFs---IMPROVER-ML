...
PARAM_COLS = [
    ...
    'wind_dir_50.0', 'temp_30.0', 'temp_50.0', 'temp_70.0', 'wind_mean_30.0', 
    'wind_mean_50.0', 'wind_mean_70.0', 'wind_gust_30.0', 'wind_gust_50.0', 
    'wind_gust_70.0', 'month', 'day', 'hour', 'lead', 'vis_cat_30.0', 
    'vis_cat_50.0', 'vis_cat_70.0', 'cld_cat_30.0', 'cld_cat_50.0', 
    'cld_cat_70.0'
]
